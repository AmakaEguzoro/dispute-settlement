...
public myDatePickerOptions: IMyOptions = {
  ...
  // disableUntil: {year: this.DateObj.getFullYear()+1 , month: this.DateObj.getMonth()+1, day: this.DateObj.getDate()+1}
};

deafaultDate: any = new Date().toISOString().split('T')[0]
  methods = ['card', 'cash', 'mcash'];
  stat = ['failed', 'successful', 'declined', 'debited', 'pending'];
  vendTypes = ['B2B', 'ITEX']
  ...
  searchTrans() {
    ...
    console.log(this.paload.transactionStatus);
