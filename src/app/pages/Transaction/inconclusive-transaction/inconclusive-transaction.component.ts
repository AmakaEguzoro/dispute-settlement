...
@Component({
  selector: 'app-inconclusive-transaction',
  templateUrl: './inconclusive-transaction.component.html',
  styleUrls: ['./inconclusive-transaction.component.scss']
})
export class InconclusiveTransactionComponent implements OnInit {
  // Details
  isData: boolean;
  loading = true;
  data: any;
  ...
  getSocketData() {
    this.socket.getMessage().subscribe((Socketdata: any) => {
      ...
      if (Socketdata.data.status == "initialized") {
  ...
  pageChanged(event: any): void {
    ...
    this.router.navigateByUrl("inconclusive/transaction", {
