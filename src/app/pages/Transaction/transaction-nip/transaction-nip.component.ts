...
@Component({
  selector: "app-transaction-nip",
  templateUrl: "./transaction-nip.component.html",
  styleUrls: ["./transaction-nip.component.scss"]
})
export class TransactionNipComponent implements OnInit {
  isData: boolean;
  showing: any = "home";
  data: any;
  transaction: any;
  ...
  TransactionSummaryNip(payload) {
    this.isData = true;
    this.isLoading = true;
    this.transactionService.getTransactionSummaryNip(payload).subscribe(
      data => {
        this.isLoading = false;
        this.summaryData = data;
        this.sessionOneAmount = this.summaryData.sessionOneAmount;
        this.sessionOneCount = this.summaryData.sessionOneCount;
        this.sessionTwoAmount = this.summaryData.sessionTwoAmount;
        this.sessionTwoCount = this.summaryData.sessionTwoCount;
        this.sessionThreeAmount = this.summaryData.sessionThreeAmount;
        this.sessionThreeCount = this.summaryData.sessionThreeCount;
        this.sessionFourAmount = this.summaryData.sessionFourAmount;
        this.sessionFourCount = this.summaryData.sessionFourCount;
  ...
  exportToExcel(session) {
    ...
    if (this.userName() != "Providus") {
      this.isData = true;
      this.isExportLoading = true;
      this.transactionService.exportTableNip(payload).subscribe(
        data => {
          this.isExportLoading = false;
          this.exportData = data;
          this.excelService.exportAsExcelFile(
            this.exportData,
            "ITEX-NIP-Session-Report" + this.dateRange
          );
        },
        error => {
          this.isData = false;
